...
Colors in the GLOW system are represented as **standard decimal integer color codes**. You can use any valid decimal color value between:
...
| 🎨 Color Name | 🔢 Decimal Value | 🖌️ Preview |
|---------------|-----------------|-------------|
...
<p align="center">
  <sub>📖 See <a href="./effects.md">effects.md</a> for available effects | See <a href="./fonts.md">fonts.md</a> for available fonts</sub>
</p>