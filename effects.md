...
GLOW supports **6 different visual effects** for your Discord Display Name. Each effect gives your bot's name a unique look and feel.

---

## 🎯 Available Effects

| Effect ID | Effect Name | Preview Description |
|-----------|-------------|-------------------|
...
| 🌈 **Gradient** (`2`) | ⚠️ **Exactly 2 colors** required |
...
<p align="center">
  <sub>📖 See <a href="./colors.md">colors.md</a> for color values | See <a href="./fonts.md">fonts.md</a> for available fonts</sub>
</p>